...
module "tls_private_key_root" {
    source                                          = "../../modules/tls"
    name                                            = "RootCA"

    enable_tls_private_key                          = "true"
    tls_private_key_algorithm                       = "ECDSA"
    tls_private_key_ecdsa_curve                     = "P521"
    tls_private_key_rsa_bits                        = "2048"
}

module "tls_self_signed_cert_root" {
    source                                          = "../../modules/tls"
    name                                            = "RootCA"

    enable_self_signed_cert                         = "true"
    tls_self_signed_cert_key_algorithm              = "${element(module.tls_private_key_root.tls_private_key_algorithm, 0)}"
    tls_self_signed_cert_private_key_pem            = "${element(module.tls_private_key_root.tls_private_key_private_key_pem, 0)}"
    #tls_self_signed_cert_private_key_pem           = "${file("file.pem")}"

    tls_self_signed_cert_subject_common_name            = "Mycompany Inc. Root"
    tls_self_signed_cert_subject_organization           = "Mycompany, Inc."
    tls_self_signed_cert_subject_organizational_unit    = "Department of Certificate Authority"
    tls_self_signed_cert_subject_street_address         = ["5879 Cotton Link"]
    tls_self_signed_cert_subject_locality               = "Santa Monica"
    tls_self_signed_cert_subject_province               = "CA"
    tls_self_signed_cert_subject_country                = "US"
    tls_self_signed_cert_subject_postal_code            = "95559-1227"

    tls_self_signed_cert_validity_period_hours          = "26280"
    tls_self_signed_cert_early_renewal_hours            = "8760"
    tls_self_signed_cert_is_ca_certificate              = "true"
    tls_self_signed_cert_allowed_uses                   = ["cert_signing", "digital_signature", "server_auth"]
...
module "tls_cert_request_node" {
    source                                          = "../../modules/tls"
    name                                            = "node-test"

    enable_tls_cert_request                         = "true"
    tls_cert_request_key_algorithm                  = "${element(module.tls_private_key_node.tls_private_key_algorithm, 0)}"
    tls_cert_request_private_key_pem                = "${element(module.tls_private_key_node.tls_private_key_private_key_pem, 0)}"

    tls_cert_request_subject_common_name            = "*.mycompany.com"
    tls_cert_request_subject_organization           = "Mycompany, Inc"
    tls_cert_request_subject_organizational_unit    = "aws nodes"
    tls_cert_request_subject_street_address         = ["5879 Cotton Link"]
    tls_cert_request_subject_locality               = "Santa Monica"
    tls_cert_request_subject_province               = ""
    tls_cert_request_subject_country                = "US"
    tls_cert_request_subject_postal_code            = ""
    tls_cert_request_subject_postal_serial_number   = ""
}

module "tls_locally_signed_cert_node" {
    source                                          = "../../modules/tls"
    name                                            = "node-test"

    enable_locally_signed_cert                      = "true"
    cert_request_pem                                = "${element(module.tls_cert_request_node.tls_cert_request_cert_request_pem, 0)}"
    ca_key_algorithm                                = "${element(module.tls_private_key_node.tls_private_key_algorithm, 0)}"
    ca_private_key_pem                              = "${element(module.tls_private_key_node.tls_private_key_private_key_pem, 0)}"
    ca_cert_pem                                     = "${element(module.tls_self_signed_cert_root.tls_self_signed_cert_cert_pem, 0)}"

    locally_validity_period_hours                   = "17520"
    locally_early_renewal_hours                     = "8760"
