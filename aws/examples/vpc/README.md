...
- `subnet_vpc_id` - The VPC ID. (`default       = ""`).
- `azs` - A list of Availability zones in the region (`default     = []`).
- `availability_zones` - A list of Availability zones in the region (`default     = {
...
- `internet_gw_vpc_id` - The VPC ID to create in. (`default       = ""`).
