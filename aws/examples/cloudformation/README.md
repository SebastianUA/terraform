...
First of all, have to create the ```AWSCloudFormationStackSetExecutionRole``` role with the next policy:
```
{
    "Version": "2012-10-17",
    "Statement": [
...
After it, adding the next trust relationships:
```
{
  "Version": "2012-10-17",
  "Statement": [
    ...
    },
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::XXXXXXXXXXXXXXXXXXXXXXXXX:root"
      },
      "Action": "sts:AssumeRole"
    },
    {
      ...
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::XXXXXXXXXXXXXXXXXXXXXXXXX:role/cloudformation-role"
      },
      "Action": "sts:AssumeRole"
    }
  ]
...
Where, ```XXXXXXXXXXXXXXXXXXXXXXXXX``` it's your account ID.
