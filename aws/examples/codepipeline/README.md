...
- `codepipeline_artifact_store_region` - (Optional) The region where the artifact store is located. Required for a cross-region CodePipeline, do not provide for a single-region CodePipeline. (`default = null`)
...
- `codepipeline_stage1_action_configuration` - (Optional) A Map of the action declaration's configuration. Find out more about configuring action configurations in the Reference Pipeline Structure documentation. (`default = null`)
- `codepipeline_stage1_action_input_artifacts` - (Optional) A list of artifact names to be worked on. (`default = null`)
- `codepipeline_stage1_action_output_artifacts` - (Optional) A list of artifact names to output. Output artifact names must be unique within a pipeline. (`default = null`)
- `codepipeline_stage1_action_role_arn` - (Optional) The ARN of the IAM service role that will perform the declared action. This is assumed through the roleArn for the pipeline. (`default = null`)
- `codepipeline_stage1_action_run_order` - (Optional) The order in which actions are run. (`default = null`)
- `codepipeline_stage1_action_region` - (Optional) The region in which to run the action. (`default = null`)
...
- `codepipeline_stage2_action_configuration` - (Optional) A Map of the action declaration's configuration. Find out more about configuring action configurations in the Reference Pipeline Structure documentation. (`default = null`)
- `codepipeline_stage2_action_input_artifacts` - (Optional) A list of artifact names to be worked on. (`default = null`)
- `codepipeline_stage2_action_output_artifacts` - (Optional) A list of artifact names to output. Output artifact names must be unique within a pipeline. (`default = null`)
- `codepipeline_stage2_action_role_arn` - (Optional) The ARN of the IAM service role that will perform the declared action. This is assumed through the roleArn for the pipeline. (`default = null`)
- `codepipeline_stage2_action_run_order` - (Optional) The order in which actions are run. (`default = null`)
- `codepipeline_stage2_action_region` - (Optional) The region in which to run the action. (`default = null`)
...
- `codepipeline_stage3_action_configuration` - (Optional) A Map of the action declaration's configuration. Find out more about configuring action configurations in the Reference Pipeline Structure documentation. (`default = null`)
- `codepipeline_stage3_action_input_artifacts` - (Optional) A list of artifact names to be worked on. (`default = null`)
- `codepipeline_stage3_action_output_artifacts` - (Optional) A list of artifact names to output. Output artifact names must be unique within a pipeline. (`default = null`)
- `codepipeline_stage3_action_role_arn` - (Optional) The ARN of the IAM service role that will perform the declared action. This is assumed through the roleArn for the pipeline. (`default = null`)
- `codepipeline_stage3_action_run_order` - (Optional) The order in which actions are run. (`default = null`)
- `codepipeline_stage3_action_region` - (Optional) The region in which to run the action. (`default = null`)
