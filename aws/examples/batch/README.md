# Work with AWS BATCH via terraform
...
- `enable_batch_job_definition` - Enable batch job definition usage (`default = ""`)
...
- `enable_batch_compute_environment` - Enable batch compute environment usage (`default = ""`)
...
- `enable_batch_job_queue` - Enable batch job queue usage (`default = ""`)
