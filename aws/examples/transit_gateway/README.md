# Work with AWS TRANSIT_GATEWAY via terraform
...
- `enable_transit_gateway` - Enable transit gateway (`default = ""`)
...
- `enable_transit_gateway_vpc_attachment` - Enable TGW vpc attachment usage (`default = ""`)
...
- `enable_transit_gateway_vpc_attachment_accepter` - Enable TGW vpc attachment accepter usage (`default = ""`)
...
- `enable_transit_gateway_route_table` - Enable TGW route table usage (`default = ""`)
...
- `enable_transit_gateway_route` - Enable TGW route usage (`default = ""`)
...
- `transit_gateway_route_blackhole` - (Optional) Indicates whether to drop traffic that matches this route (default to false). (`default = ""`)
- `enable_transit_gateway_route_table_propagation` - Enable TGE route table propagation usage (`default = ""`)
...
- `enable_transit_gateway_route_table_association` - Enable TGW route table association usage (`default = ""`)
...
- `enable_transit_gateway_peering_attachment` - Enable TGW peering attachment usage (`default = ""`)
...
- `enable_transit_gateway_peering_attachment_accepter` - Enable TGW peering attachment accepter usage (`default = ""`)
