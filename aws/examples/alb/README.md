...
- `enable_alb` - Enable ALB usage (`default = ""`)
- `enable_alb_logs` - Enable ALB usage (`default = ""`)
- `enable_alb_prefix` - Enable ALB with name_prefix usage (`default = ""`)
...
- `lb_internal` - If true, ALB will be an internal ALB (`default = ""`)
...
- `access_logs_enabled` - (Optional) Boolean to enable / disable access_logs. Defaults to false, even when bucket is specified. (`default = ""`)
...
- `tg_name_prefix` - Enable ALB with name_prefix usage (`default = ""`)
- `enable_alb_target_group` - Enable alb target group (`default = ""`)
- `enable_alb_target_group_prefix` - Enable alb target group (`default = ""`)
...
- `alb_target_group_attachment` - Enable to use alb_target_group_attachment (`default = ""`)
- `alb_target_group_attachment_prefix` - Enable to use alb_target_group_attachment (`default = ""`)
...
- `enable_lb_listener_certificate` - Enable alb listener certificate (`default = ""`)
- `enable_lb_listener_certificate_prefix` - Enable alb listener certificate (`default = ""`)
- `listener_arn` - (Required, Forces New Resource) The ARN of the listener to which to attach the certificate. (`default = ""`)
- `enable_lb_listener_rule` - Enable alb listener rule (`default = ""`)
- `enable_lb_listener_rule_redirect` - Enable alb listener rule with redirect (`default = ""`)
- `enable_lb_listener_rule_prefix` - Enable alb listener rule (`default = ""`)
- `lb_listener_rule_forward` - Enable alb listener rule for forwarding (`default = ""`)
- `lb_listener_rule_redirect` - Enable alb listener rule for redirecting (`default = ""`)
- `lb_listener_rule_fixed_response` - Enable alb listener rule for fixed response (`default = ""`)
- `enable_lb_listener_rule_cognito` - Enable alb listener rule for cognito (`default = ""`)
- `enable_lb_listener_rule_oidc` - Enable alb listener rule for oidc (`default = ""`)
