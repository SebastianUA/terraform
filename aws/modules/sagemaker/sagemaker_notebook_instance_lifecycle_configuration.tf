...
resource "aws_sagemaker_notebook_instance_lifecycle_configuration" "sagemaker_notebook_instance_lifecycle_configuration" {
  ...
  name      = var.sagemaker_notebook_instance_lifecycle_configuration_name != "" ? lower(var.sagemaker_notebook_instance_lifecycle_configuration_name) : "${lower(var.name)}-notebook-inst-lc-conf-${lower(var.environment)}"
