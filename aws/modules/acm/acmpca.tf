...
resource "aws_acmpca_certificate_authority" "acmpca_certificate_authority_default" {
    count                           = "${var.acmpca_certificate_authority_default && !var.acmpca_certificate_authority_revocation_configuration ? 1 : 0}"
...
resource "aws_acmpca_certificate_authority" "acmpca_certificate_authority_revocation_configuration" {
    count                           = "${!var.acmpca_certificate_authority_default && var.acmpca_certificate_authority_revocation_configuration ? 1 : 0}"
