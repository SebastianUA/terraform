...
resource "aws_opsworks_static_web_layer" "opsworks_static_web_layer" {
  ...
  dynamic "ebs_volume" {
    ...
    content {
      mount_point     = lookup(opsworks_static_web_layer_ebs_volume.value, "mount_point", null)
      size            = lookup(opsworks_static_web_layer_ebs_volume.value, "size", null)
      number_of_disks = lookup(opsworks_static_web_layer_ebs_volume.value, "number_of_disks", null)
      raid_level      = lookup(opsworks_static_web_layer_ebs_volume.value, "raid_level", null)
      type            = lookup(opsworks_static_web_layer_ebs_volume.value, "type", null)
      iops            = lookup(opsworks_static_web_layer_ebs_volume.value, "iops", null)
    }
  }
