...
resource "aws_apigatewayv2_route_response" "apigatewayv2_route_response" {
  ...
  route_id           = var.apigatewayv2_route_response_route_id != "" ? var.apigatewayv2_route_response_route_id : (var.enable_apigatewayv2_api ? aws_apigatewayv2_route.apigatewayv2_route[count.index].id : null)
