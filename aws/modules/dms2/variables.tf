...
variable "dms_certificates" {
  description = "Set list of DMS certificates"
  default     = []
}
...
variable "dms_endpoints" {
  description = "Set list of dms endpoints"
  default     = []
}
...
variable "dms_replication_tasks" {
  description = "Set list of dms replication tasks"
  default     = []
}
...
variable "dms_event_subscriptions" {
  description = "Set list of dms event subscription"
  default     = []
}
