...
resource "aws_vpc_endpoint_service_allowed_principal" "vpc_endpoint_service_allowed_principal" {
  ...
  vpc_endpoint_service_id = var.vpc_endpoint_service_allowed_principal_vpc_endpoint_service_id != "" ? var.vpc_endpoint_service_allowed_principal_vpc_endpoint_service_id : (var.enable_vpc_endpoint_service ? element(aws_vpc_endpoint_service.vpc_endpoint_service.*.id, count.index) : null)
