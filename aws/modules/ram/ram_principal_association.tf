...
resource "aws_ram_principal_association" "ram_principal_association" {
  ...
  resource_share_arn = !var.enable_ram_resource_share && var.ram_principal_association_resource_share_arn != null ? var.ram_principal_association_resource_share_arn : aws_ram_resource_share.ram_resource_share[0].arn
