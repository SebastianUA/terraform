...
resource "aws_iam_group_policy" "iam_group_policy" {
  ...
  name        = var.iam_group_policy_name != "" && var.iam_group_policy_name_prefix == "" ? var.iam_group_policy_name : null
  name_prefix = var.iam_group_policy_name_prefix != "" && var.iam_group_policy_name == "" ? var.iam_group_policy_name_prefix : null
