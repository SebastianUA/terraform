...
resource "aws_iam_policy_attachment" "iam_policy_attachment" {
  ...
  policy_arn = var.iam_policy_attachment_policy_arn != "" && !var.enable_iam_policy ? var.iam_policy_attachment_policy_arn : element(concat(aws_iam_policy.iam_policy.*.arn, [""]), 0)
