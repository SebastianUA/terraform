...
resource "aws_config_configuration_recorder_status" "config_configuration_recorder_status" {
    ...
    name            = var.config_configuration_recorder_name != "" && !var.enable_config_configuration_recorder ? var.config_configuration_recorder_name : element(concat(aws_config_configuration_recorder.config_configuration_recorder.*.name , [""]), 0)
