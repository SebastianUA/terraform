...
variable "timeouts_delete" {
  description   = "(Default 10 minutes) Used for destroying ASG."
  default       = "10m"
}
...
variable "autoscaling_scale_up_policy" {
  description   = "Set asg policy name for scale up"
  default       = ""
}

variable "autoscaling_scale_down_policy" {
...
variable "scheduled_action_name_scale_out" {
  description   = "Set scheduled action name for scale out time"
  default       = ""
}

variable "scheduled_action_name_scale_in" {
