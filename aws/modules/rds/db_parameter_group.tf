...
resource "aws_db_parameter_group" "db_parameter_group" {
    ...
    family          = var.family != "" ? var.family : lookup(var.db_group_family, var.engine)
    ...
    tags = merge(
        {
            "Name"          = var.db_parameter_group_name != "" ? lower(var.db_parameter_group_name) : lower(var.db_parameter_group_name_prefix)
        },
        {
