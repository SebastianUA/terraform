...
- [Database](https://github.com/SebastianUA/terraform/tree/master/azure/modules/database) - Part of the Azure SQL family, Azure SQL Database is an always-up-to-date relational database service built for the cloud. It automatically scales to meet your apps' requirements and keeps them running with up to 99.995% availability. Build your next app with the simplicity and flexibility of a fully managed multimodel database. The official documentation is here: https://azure.microsoft.com/en-us/products/azure-sql/database/#overview.
