...
- `alert_channel_email_configuration_include_json_attachment` - Set include_json_attachment (`default = True`)
...
----------------------
- `alert_channel_campfire_id` - ID for newrelic_alert_channel_campfire
